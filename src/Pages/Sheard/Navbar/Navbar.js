...
const Navbar = () => {
    return (
        <nav className='navbar-background-color shadow-lg sticky top-0 max-w-full'>
            <div className="navbar bg-base-100 container">
                <div className="navbar-start">
                    <img src={icon} alt="navBarIcon" />
                    <div className="form-control ml-2">
                        <input type="text" placeholder="&#61442; Search" className='input-color px-8 py-1 search-input-placeholder' />
                    </div>
                </div>
