        ...
        <div className='mt-3 border w-full p-2 mx-auto shadow-md rounded-lg'>
            <div className='flex items-center justify-around'>
                ...
                <button className='border px-10 py-2 rounded-full btn-background'>
                    <span className='text-xs'>Have a topic that excites you? Post about it</span>
                </button>
            </div>
            <div>
                <ul className='p-0 menu menu-horizontal'>
                    ...
                    <li>
                        <Link to='#'>
                            ...
                            <span className='text-xs'>Vedio</span>
                        </Link>
                    </li>
                    <li>
                        <Link to='#'>
            ...
            <div className='flex items-center'>
                <div style={{ height: '1px' }} className='w-[70%] bg-slate-300'></div>
